...
PETicle 팀은 한이음 학점연계형 프로젝트를 통해, 자발적 참여가 부족한 청소년(중·고등학생)들이 즐겁게 환경 보호에 동참할 수 있도록 AI 분리배출 수거기와 게임 서비스를 결합한 통합 시스템을 개발합니다.
...
| **김혜인** | **Admin-App** | 관리자 앱 프론트엔드/백엔드 개발 |
| **박고운** | **User-App** | 유저용 앱 프론트엔드/백엔드 개발, 유니티 게임 개발 |
